package net.ayoub.tutorialmod.item;
...
public class ModCreativeModeTabs {
    ...
    public static final Supplier<CreativeModeTab> MY_ITEMS_AND_BLOCKS=
            CREATIVE_MODE_TAB.register("my_items_and_blocks",
                    ()-> CreativeModeTab.builder().icon(()-> new ItemStack(ModBlocks.MY_BLOCK.get()))
                            .title(Component.translatable("creativetab.tutorialmod.my_items_and_blocks"))
